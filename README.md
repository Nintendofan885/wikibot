...
* Import Wikimedia database backup dumps data to user-created database on [Toolforge](https://toolforge.org/). (See [process_dump.js](https://github.com/kanasimi/wikibot/blob/master/task/process_dump.js))
